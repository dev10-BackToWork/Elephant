...
public class ServiceLayer {
    ...
    public User createUser(User user) throws DataFormatException {
        ...
        if (dbUser != null) {
            Mailer.send(sendEmail, emailPW, dbUser.getEmail(), "Account Created", "<p>Hello "
                    + dbUser.getFirstName()
                    ...
                    + "<p>This is an automatically generated email from the <span style=\"color: rgb(228,112,31)\"><strong> Gen10 Health App</strong></span>.</p>"
                    );
        }
        return dbUser;
    }
