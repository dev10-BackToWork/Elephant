...
public class AdminController {
    ...
    @GetMapping("/user/{id}")
    public ResponseEntity<User> getUserById(@PathVariable int id, @RequestHeader("email") String email,
    ...
    @CrossOrigin(origins = "https://044db60.netsolhost.com")
    @GetMapping("/users/{id}")
    public ResponseEntity<List<User>> getUsers(@PathVariable int id, @RequestHeader("email") String email,
            @RequestHeader("password") String password) {
        try {
            service.checkAdmin(email, password);
    ...
    public ResponseEntity<List<User>> getGuests(@PathVariable int id, @RequestHeader("email") String email,
            @RequestHeader("password") String password) {
        try {
            service.checkAdmin(email, password);
    ...
    @CrossOrigin(origins = "https://044db60.netsolhost.com")
    @GetMapping("/roles")
    public ResponseEntity<List<Role>> getRoles(@RequestHeader("email") String email,
            @RequestHeader("password") String password) {
        try {
            service.checkAdmin(email, password);
    ...
    public ResponseEntity<List<Attendance>> getOccupants(@PathVariable int id, @RequestHeader("email") String email,
            @RequestHeader("password") String password) {
        try {
            service.checkAdmin(email, password);
    ...
    public ResponseEntity<List<User>> getInactiveUsers(@PathVariable int id, @RequestHeader("email") String email,
            @RequestHeader("password") String password) {
        try {
            service.checkAdmin(email, password);
    ...
    public ResponseEntity<List<User>> getFlagged(@PathVariable int id, @RequestHeader("email") String email,
            @RequestHeader("password") String password) {
        try {
            service.checkAdmin(email, password);
    ...
    public ResponseEntity<List<User>> getFlaggedGlobal(@RequestHeader("email") String email,
            @RequestHeader("password") String password) {
        try {
            service.checkAdmin(email, password);
    ...
    public ResponseEntity<List<Location>> getLocations(@RequestHeader("email") String email,
            @RequestHeader("password") String password) {
        try {
            service.checkAdmin(email, password);
    ...
    @CrossOrigin(origins = "https://044db60.netsolhost.com")
    @PostMapping("/newUser")
    public ResponseEntity<User> createUser(@RequestBody User user, @RequestHeader("email") String email,
            @RequestHeader("password") String password) {
        try {
            service.checkAdmin(email, password);
            try {
    ...
    public ResponseEntity<User> createGuest(@RequestBody User guest, @RequestHeader("email") String email,
            @RequestHeader("password") String password) {
        try {
            service.checkAdmin(email, password);
            try {
    ...
    public ResponseEntity<User> editUser(@RequestBody User user, @RequestHeader("email") String email,
            @RequestHeader("password") String password) {
        try {
            service.checkAdmin(email, password);
    ...
    public ResponseEntity<Attendance> signUpGuest(@RequestBody Attendance attendance,
    ...
    public ResponseEntity<User> resetPassword(@PathVariable int id, @RequestHeader("email") String email,
            @RequestHeader("password") String password) {
        try {
            service.checkAdmin(email, password);
    ...
    public ResponseEntity<User> deleteUser(@PathVariable int id, @RequestHeader("email") String email,
            @RequestHeader("password") String password) {
        try {
            service.checkAdmin(email, password);
    ...
    public ResponseEntity<Boolean> generatePasswords(@RequestHeader("email") String email,
            @RequestHeader("password") String password) {
    ...
    public ResponseEntity<List<Attendance>> attendanceReport(@PathVariable int id, @PathVariable String date,
            @RequestHeader("email") String email, @RequestHeader("password") String password) {
        try {
            service.checkAdmin(email, password);
    ...
    public ResponseEntity<User> deactivateUser(@PathVariable int id, @RequestHeader("email") String email,
            @RequestHeader("password") String password) {
        try {
            service.checkAdmin(email, password);
    ...
    public ResponseEntity<User> reactivateUser(@PathVariable int id, @RequestHeader("email") String email,
            @RequestHeader("password") String password) {
        try {
            service.checkAdmin(email, password);
    ...
    public ResponseEntity<List<Attendance>> datesPresent(@PathVariable int id, @RequestHeader("email") String email,
            @RequestHeader("password") String password) {
        try {
            service.checkAdmin(email, password);
    ...
    public ResponseEntity<TreeMap<LocalDate, List<User>>> attendanceDuringRange(@PathVariable int id,
            @PathVariable String startDate, @PathVariable String endDate, @RequestHeader("email") String email,
            @RequestHeader("password") String password) {
        try {
            service.checkAdmin(email, password);
            return new ResponseEntity<TreeMap<LocalDate, List<User>>>(
                    service.generateAttendanceDuringRange(id, startDate, endDate), HttpStatus.OK);
        } catch (invalidCredentialsException e) {
    ...
    public ResponseEntity<List<User>> attendanceDuringRangeSummary(@PathVariable int id, @PathVariable String startDate,
            @PathVariable String endDate, @RequestHeader("email") String email,
            @RequestHeader("password") String password) {
        try {
            service.checkAdmin(email, password);
            return new ResponseEntity<List<User>>(service.generateAttendanceDuringRangeSummary(id, startDate, endDate),
                    HttpStatus.OK);
        } catch (invalidCredentialsException e) {
            String message = "There was an error while attempt to trace contact with other users in the office.";
            return new ResponseEntity(message, HttpStatus.BAD_REQUEST);
    ...
    public ResponseEntity<Attendance> departedEarly(@PathVariable int id, @RequestHeader("email") String email,
            @RequestHeader("password") String password) {
        try {
            service.checkAdmin(email, password);
